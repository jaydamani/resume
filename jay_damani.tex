...
\begin{itemize}
    \item TCD is a command based chat-bot that makes common tasks in discord easier.
          % \item Integrated with the unsplash API to query images based on user input.
          % \item Implemented customizable banners to showcase xp/level of the user using canvas.
